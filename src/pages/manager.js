      ...
      >
        ...
        <input
          ...
          {...register("name", {
            ...
            minLength: {
              value: 5,
              message: "Product name must be between 2 character and 10 character"
          }
          })}
        ></input>
        {errors.name && (
          ...
          data.products.map((product) => {
            return (
              <tr key={product._id}>
                ...
                <a className="btn btn-danger m-2" onClick={handleOpen}
               >
                  Edit
                </a>
                <Modal
                  ...
                  className="bg-body "
                >
                   <form onSubmit={handleSubmit(onUpdata)} className="form-register">
        <h1>  <b>UPDATE</b> </h1>
        {/* id */}
        <label htmlFor="id"> product id</label>
        <input name="name" type="text" value={product.id}
        {...register("id")}>
           </input>
         {/* name */}
        <label htmlFor="name"> name</label>
